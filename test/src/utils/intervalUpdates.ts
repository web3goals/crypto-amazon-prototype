...
export function updatePoolDayData(
  ...
  const dayPoolID = poolAddress.concat("-").concat(dayID.toString()).concat("-").concat(chainId.toString()); // poolAddress + "-" + dayId + "-" + chainId
...
export function updatePoolHourData(
  ...
  const poolAddress = getFromId(pool.id).address;
  const hourPoolID = poolAddress.concat("-").concat(hourIndex.toString()).concat("-").concat(chainId.toString());
...
export function updateTokenDayData(
  ...
  const tokenDayID = tokenAddress.concat("-").concat(dayID.toString()).concat("-").concat(chainId.toString());
...
export function updateTokenHourData(
  ...
  const hourStartUnix = getHourStartUnix(hourIndex); // want the rounded effect
  const tokenAddress = getFromId(token.id).address;
  const tokenHourID = tokenAddress.concat("-").concat(hourIndex.toString()).concat("-").concat(chainId.toString());
