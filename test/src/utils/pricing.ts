...
import { Bundle, Pool, Token, loaderContext } from "generated/src/Types.gen";
import { exponentToBigDecimal, getFromId, getId, safeDiv } from "../utils/index";
...
export function getNativePriceInUSD(stablecoinIsToken0: boolean, stablecoinWrappedNativePool?: Pool): BigDecimal {
...
export async function findNativePerToken(
  ...
  return priceSoFar.decimalPlaces(18); // nothing was found return 0
}
...
export function getTrackedAmountUSD(
  ...
  if (whitelistTokens.includes(token0Address) && whitelistTokens.includes(token1Address)) {
